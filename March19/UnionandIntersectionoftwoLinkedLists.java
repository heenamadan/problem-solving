...
public class UnionandIntersectionoftwoLinkedLists {
    ...
    UnionandIntersectionoftwoLinkedLists getIntersection(Node head1, Node head2)
    {
        HashSet<Integer> hset = new HashSet<>();
        Node n1 = head1;
        Node n2 = head2;
        UnionandIntersectionoftwoLinkedLists result = new UnionandIntersectionoftwoLinkedLists();
    ...
    UnionandIntersectionoftwoLinkedLists getUnion(Node head1, Node head2)
    {
    ...
    public static void main(String args[])
    {
        ...
        UnionandIntersectionoftwoLinkedLists union = new UnionandIntersectionoftwoLinkedLists();
        UnionandIntersectionoftwoLinkedLists intersection = new UnionandIntersectionoftwoLinkedLists();
