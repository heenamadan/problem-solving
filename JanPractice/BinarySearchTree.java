...
class BinarySearchTree {
    ...
    // every node
    void modifyBSTUtilFromRight(Node node, Sum S)
    {
        // Base Case
        if (node == null)
            return;
        ...
        this.modifyBSTUtilFromRight(node.right, S);
        ...
        this.modifyBSTUtilFromRight(node.left, S);
    }

    void modifyBSTUtilFromLeft(Node node, Sum S)
    {
        // Base Case
        if (node == null)
            return;
        ...
        // Recur for right subtree
        this.modifyBSTUtilFromLeft(node.left, S);
        ...
        // Recur for left subtree
        this.modifyBSTUtilFromLeft(node.right, S);
    }
    ...
    {
        Sum S = new Sum();
      //  this.modifyBSTUtilFromRight(node, S);


        this.modifyBSTUtilFromLeft(node, S);
    }
